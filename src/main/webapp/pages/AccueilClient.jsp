            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
              ...
              <ul class="navbar-nav">
                <li class="nav-item nav-link active">
                    <a class="nav-link" href="AccueilClient.jsp"> Accueil </span></a>
                </li>
                ...
                <li class="nav-item nav-link" id="idBarre">
                      ...
                      <form action="${pageContext.request.contextPath}/gestionClient/rechercher" method="POST">
                      <input type="text" name="libProduit" placeholder="Rechercher">
        ...
        <div class="col-6">  <br> 
            <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    <a href="/gestionClient/afficherCategorie"> Categories</a>
        ...
        <div class="col-6"><br> 
            <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    <a href="/gestionClient/afficherProduit">Produits</a>
                </div>
             </div>
        </div> 
    </div>
